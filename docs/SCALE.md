...
- **~1000-2000 lines of prose** (specs, designs, comments)
- **Combined**: if your spec + design + relevant code exceeds 800 lines, you are near the danger zone. 1200 lines is the absolute maximum.
